"
These functions handle dataset import and pre-processing on the basis of CAR BCs.
This includes filtering on conventional QC metrics, calling cells by HTO, and calling
cells by CAR BC. CAR identity is stored in a metadata column, labeled 'CARID'.
...
create_seurat <- function(mat_path = './filtered_feature_bc_matrix', preloaded_counts = NULL,
                          ...
                          remove_CARs = 'CAR22', filter_genes = NULL,
